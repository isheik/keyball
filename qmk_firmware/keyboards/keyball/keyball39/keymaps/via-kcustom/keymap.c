...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    switch (layer) {
        case 0:
            rgblight_sethsv(HSV_WEAK_GOLD);
            break;
        case 1:
            rgblight_sethsv(HSV_WEAK_CYAN);
            break;
        case 2:
            rgblight_sethsv(HSV_WEAK_TURQUOISE);
            break;
        case 3:
            rgblight_sethsv(HSV_WEAK_BLUE);
            break;
        case 4:
            rgblight_sethsv(HSV_WEAK_GREEN);
            break;
    }
